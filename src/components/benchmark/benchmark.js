    ...
    <div className="benchmark__container">
      ...
      <div className="benchmark__right">
        <form>
          <section>
            <label
              htmlFor="selectedBenchmark"
              className="sbenchmark__right__text__label"
            />
            <select
              className="benchmark__right__text"
              id="setBenchmark"
            ...
            >
              ...
              <option value="VTSMX ETF">
                60% stocks, 40% bonds (VTSMX ETF)
              </option>
              <option value="VBMFX ETF">
                20% stocks, 80% bonds (VBMFX ETF)
              </option>
            </select>
          </section>
        </form>
